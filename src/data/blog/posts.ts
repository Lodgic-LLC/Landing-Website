...
export const blogPosts: BlogPost[] = [
  {
    ...
    imageAlt:
      "Code et interface de développement web moderne sur un écran d'ordinateur",
...
function MyButton() {
  ...
  },
  {
    ...
    imageAlt:
      "Équipe collaborant sur la conception d'une interface web pour une landing page efficace",
    category: "Web",
    content: `
  ...
  },
  {
    ...
    imageAlt:
      "Site web affiché sur différents appareils : ordinateur, tablette, smartphone",
    category: "Développement",
    content: `
...
const ContenuNettoye = ({ htmlBrut }) => {
  ...
  },
  {
    ...
    title:
      "L'Architecture à Base de Composants : La clé du Développement Web Moderne",
    date: "2025-05-12",
    author: "L'équipe Lodgic",
    summary:
    ...
    imageAlt:
      "Schéma illustrant une architecture à base de composants sur un écran d'ordinateur",
    category: "Développement",
    content: `
