...
export const blogPosts: BlogPost[] = [
  {
    ...
    summary:
      "Découvrez les dernières bonnes pratiques en matière d'accessibilité web pour créer des sites inclusifs et conformes aux normes WCAG 2.2 et 3.0.",
    imageUrl:
...
const getUserCommand = HystrixCommand.getOrCreate('getUser')
  ...
  },
  {
    ...
    category: 'Développement',
    tags: ['TypeScript', 'JavaScript', 'Développement', 'Typage', 'Bonnes pratiques'],
    content: `
