...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: `
      ...
      <h2>Les Avantages du JAMstack</h2>
      ...
      <h2>Les Technologies Clés du JAMstack</h2>
      ...
      <h2>Mettre en Place un Projet JAMstack</h2>
...
netlify deploy --prod</code></pre>
      ...
      <h2>Cas d'Usage Idéaux pour JAMstack</h2>
...
const ContenuNettoye = ({ htmlBrut }) => {
  ...
  },
  {
    ...
    title: "L'Architecture à Base de Composants : Clé de Voûte du Développement Web Moderne",
    date: '2025-05-12',
    author: "L'équipe Lodgic",
    summary:
    ...
    content: `
      ...
      <h2>Qu\'est-ce que l\'Architecture à Base de Composants ?</h2>
      ...
      <p>Un composant peut être aussi simple qu\'un bouton ou une icône, ou aussi complexe qu\'un formulaire de contact entier, un carrousel d\'images, ou même une section entière d\'une page. L\'idée principale est que ces composants peuvent être développés et testés isolément, puis combinés pour former l\'application complète.</p>
      ...
      <h2>Les Avantages Majeurs de cette Approche</h2>
      ...
      <h2>Frameworks Populaires et Écosystème</h2>
      ...
      <h2>Principes de Conception d\'un Bon Composant</h2>
