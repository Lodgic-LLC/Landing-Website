...
import { FaCode, FaRocket, FaPlug, FaTools, FaChevronRight, FaMobile } from 'react-icons/fa'
      ...
      <section className="py-20 bg-gradient-to-r from-gray-50 to-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16" data-aos="fade-up">
            <h2 className="text-3xl md:text-4xl font-inter-bold text-gray-900 mb-4">Notre méthode de travail</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              >
                <div className="absolute top-0 left-0 w-2 h-full" style={{ backgroundColor: phase.color }}></div>
                <div className="text-4xl font-bold mb-4" style={{ color: phase.color }}>
                  {phase.step}
                </div>
          ...
          <div className="flex flex-col lg:flex-row md:flex-row items-center justify-between gap-10">
            <div className="w-full md:w-3/5" data-aos="fade-right">
              ...
              <p className="text-base md:text-lg text-blue-100 mb-6 max-w-2xl">
                Nous créons des outils numériques adaptés à vos besoins spécifiques. Discutons ensemble de votre projet
                pour trouver la solution la plus efficace et la plus simple à utiliser.
              </p>
