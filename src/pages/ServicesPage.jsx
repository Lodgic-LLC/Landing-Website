...
const ServicesPage = () => {
  ...
  const mainServices = [
    {
      ...
      description:
        "Création d'applications web robustes et évolutives avec les dernières technologies pour optimiser vos processus métier et améliorer votre présence digitale.",
    ...
    // ... existing code ...
    {
      ...
      description:
        "Modernisation de vos applications existantes pour améliorer les performances, l'expérience utilisateur et la sécurité de vos solutions digitales.",
    ...
    },
    {
      ...
      description:
        'Connexion et automatisation de vos systèmes via des API robustes pour une efficacité maximale et une meilleure interopérabilité de vos outils.',
    ...
    },
    {
      ...
      description:
        'Service complet de maintenance technique, mises à jour de sécurité et support pour garantir la performance et la fiabilité de votre site sur le long terme.',
  ...
  return (
    <>
      <PageTitle title="Nos services" description="Solutions web sur mesure pour votre entreprise" />
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center max-w-3xl mx-auto" data-aos="fade-up">
            ...
            <p className="font-inter-regular text-gray-600 mb-6 md:mb-8 text-base md:text-lg lg:text-xl leading-relaxed">
              Nous développons des applications web performantes et évolutives, parfaitement adaptées aux besoins
              spécifiques de votre activité pour vous aider à atteindre vos objectifs.
            </p>
                  ...
                  {service.id === 4 && (
                    <div className="relative z-10 flex justify-center items-center">
                      ...
                      >
                        ...
                        {/* Engrenage principal */}
                        <path
                          d="M250 110C227.909 110 210 127.909 210 150C210 172.091 227.909 190 250 190C272.091 190 290 172.091 290 150C290 127.909 272.091 110 250 110ZM250 180C233.431 180 220 166.569 220 150C220 133.431 233.431 120 250 120C266.569 120 280 133.431 280 150C280 166.569 266.569 180 250 180Z"
                          fill="#1F2937"
                        />
                        ...
                        {/* Clé à molette */}
                        <path
                          d="M180 100C180 95.5817 183.582 92 188 92H192C196.418 92 200 95.5817 200 100V110C200 114.418 196.418 118 192 118H188C183.582 118 180 114.418 180 110V100Z"
                          fill="#4B5563"
                        />
      ...
      <section className="py-20 bg-gradient-to-r from-gray-50 to-gray-100">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16" data-aos="fade-up">
            <h2 className="text-3xl md:text-4xl font-inter-bold text-gray-900 mb-4">Notre approche méthodologique</h2>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="w-full md:w-3/5 mb-10 md:mb-0" data-aos="fade-right">
              ...
              <p className="text-xl text-blue-100 mb-8 max-w-2xl">
                Discutons ensemble de vos besoins et objectifs pour créer une solution web sur mesure qui propulsera
