...
const PolitiqueConfidentialite = () => {
    return (
        <div className="bg-white pt-20">
            <Helmet>
                <title>Politique de Confidentialité | Lodgic</title>
                <meta name="description" content="Politique de confidentialité de Lodgic concernant la collecte et le traitement des données personnelles." />
            </Helmet>
