      ...
      <div className="mx-auto max-w-5xl px-6 relative z-10">
        <div className="flex flex-col items-center">
          ...
          <div className="mb-8 flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-1.5 backdrop-blur-sm">
            <span className="h-1.5 w-1.5 rounded-full bg-[#DBFF00] animate-pulse" />
            <span className="text-[10px] font-sofia-bold uppercase tracking-[0.2em] text-white/60">L'agence</span>
          </div>
          ...
          <div className="relative">
            {/* Guillemet décoratif */}
            <div className="absolute -left-4 md:-left-12 -top-8 text-6xl md:text-8xl font-sofia-bold text-[#DBFF00]/10 select-none">“</div>
            ...
            <div className="absolute -right-4 md:-right-12 -bottom-8 text-6xl md:text-8xl font-sofia-bold text-[#DBFF00]/10 select-none rotate-180">“</div>
          </div>
        </div>
      </div>
    </section>
