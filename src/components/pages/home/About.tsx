...
const About = () => {
  ...
  const testimonials = [
    {
      ...
      content: "L'équipe a transformé notre vision en une application mobile exceptionnelle. Leur approche personnalisée et leur expertise technique ont dépassé nos attentes.",
      rating: 5
    },
    {
      name: "Pierre Martin",
    ...
    },
    {
      ...
      role: "Chef de Projet",
      content: "Professionnalisme, réactivité et expertise technique au rendez-vous. Notre site web dépasse maintenant nos concurrents en termes de performance.",
      rating: 5
    },
    {
      ...
      role: "CTO",
      content: "Une équipe qui maîtrise parfaitement les technologies modernes. Ils ont su intégrer des fonctionnalités complexes tout en gardant une interface intuitive.",
      rating: 5
    },
    {
      name: "Camille Moreau",
      company: "StartupLab",
      role: "Fondatrice",
      content: "Grâce à leur expertise, nous avons pu lancer notre MVP en temps record. Un suivi personnalisé qui fait vraiment la différence.",
      rating: 5
    }
  ]
  ...
  return (
    <>
    <section className="py-10 bg-[#f6f7fc] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16 md:mb-20">
          <h2 className="text-3xl md:text-4xl font-bricolage-grotesque-bold text-[#000f45] mb-4">Qui sommes-nous ?</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto mb-12">
          ...
          <div className="bg-[#FFFFFF] p-6 md:p-8 border border-gray-200 hover:border-[#000f45]/50 hover:shadow-2xl transition-all transform hover:-translate-y-1.5 group">
            ...
            <p className="text-[#162869] font-inter mb-6 leading-relaxed text-sm sm:text-base">
              ...
              <span className="hidden md:inline">
                Mathéo apporte son expertise technique pour transformer vos idées en réalité. Son approche
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 md:p-12 border border-gray-200 relative overflow-hidden">
              ...
              <div className="text-center">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-[#162869] font-inter font-medium">
                    {testimonials[currentTestimonial].role}
                  </p>
                  <p className="text-[#162869] font-inter text-sm">
