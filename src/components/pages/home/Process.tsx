      ...
      <div className="container mx-auto px-6 max-w-6xl">
        <div className="text-center mb-16">
          ...
          <p className="text-base md:text-lg max-w-3xl mx-auto font-inter text-[#162869]/80 leading-relaxed">
            De la création de portails d'entreprise aux suites logicielles complètes. Nous maîtrisons toute la chaîne de valeur du produit numérique.
          </p>
        </div>
