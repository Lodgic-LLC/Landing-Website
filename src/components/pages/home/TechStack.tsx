...
const technologies = [
  {
    ...
    description:
      'Permet de créer des applications mobiles qui fonctionnent aussi bien sur iPhone que sur Android avec un seul code',
    color: 'bg-blue-50',
  ...
  },
  {
    ...
    description:
      "Simplifie la création et le partage d'applications mobiles, pour vous les faire tester rapidement et facilement",
    color: 'bg-gray-50',
  ...
  },
  {
    ...
    description:
      'Gère efficacement toutes vos données et informations, comme un bibliothécaire ultra-organisé pour votre application',
    color: 'bg-indigo-50',
  ...
  },
  {
    ...
    description:
      "Crée l'intelligence derrière votre application, assurant sa rapidité, sa sécurité et sa capacité à évoluer",
    color: 'bg-red-50',
    ...
    <section className="py-12 sm:py-16 md:py-20 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-10 sm:mb-16">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-4">Notre stack technologique</h2>
          <div className="w-16 sm:w-20 h-1.5 bg-blue-600 mx-auto mb-4 sm:mb-6 rounded-full"></div>
          <p className="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto px-4">
            Nous utilisons les outils les plus modernes pour créer vos applications mobiles, ce qui garantit qu'elles
            seront rapides, fiables et faciles à faire évoluer avec vos besoins.
          </p>
        </div>
            ...
            >
              ...
              <div className="flex items-center mb-3 sm:mb-4">
                <div className="relative w-10 h-10 sm:w-12 sm:h-12 mr-3 sm:mr-4 flex-shrink-0">
                  <Image src={tech.logo} alt={`${tech.name} logo`} width={48} height={48} className="object-contain" />
                </div>
              ...
              <div
                className="mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-gray-200/50 flex justify-between items-center cursor-pointer"
                onClick={handleClick}
              >
