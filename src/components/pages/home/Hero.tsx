        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12 pb-20 md:pb-24">
          ...
          <div className="w-full lg:w-1/2 pt-8 lg:pt-0">
            <div>
              ...
              Votre idée, notre savoir-faire : Un accompagnement personnalisé, un design sur mesureet une expertise technique pour créer ensemble l’application mobile qui vous ressemble.
              </p>
