            ...
            <div className="relative w-full max-w-lg aspect-square">
              ...
              <div className="relative w-full h-full flex items-center justify-center p-4">
                <svg
                  ...
                  style={{
                    filter: "drop-shadow(0px 10px 25px rgba(0,31,69,0.08))",
                  }}
                >
                  <g
                    fill="white"
