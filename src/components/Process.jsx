  ...
  const processSteps = [
    {
      ...
      number: '01',
      title: 'Analyse',
      description: 'Nous analysons ensemble vos besoins et objectifs pour mieux vous accompagner dans votre projet.',
      icon: (
    ...
    },
    {
      ...
      number: '02',
      title: 'Design',
      description: 'Création des maquettes visuelles adaptées à votre image et aux besoins de vos utilisateurs.',
      icon: (
        <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
    ...
    },
    {
      ...
      number: '05',
      title: 'Déploiement',
      description: 'Lancement de votre application et mise en place des outils de suivi pour assurer sa performance.',
      icon: (
        <svg className="w-7 h-7" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-20" data-aos="fade-up">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Une approche structurée et transparente pour transformer votre vision en réalité digitale.
          </p>
          ...
          <div className="flex justify-between relative">
            {processSteps.map((step, index) => (
              ...
              >
                ...
                <h3 className="text-xl font-inter-bold text-gray-900 mb-3">{step.title}</h3>
                <p className="text-gray-600 max-w-[220px]">{step.description}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="md:hidden space-y-8">
          {processSteps.map((step, index) => (
            <div key={step.id} className="flex items-start group" data-aos="fade-up" data-aos-delay={step.delay}>
              ...
              <div className="flex-1 pt-2">
                ...
                <h3 className="text-xl font-inter-bold text-gray-900 mb-2">{step.title}</h3>
        ...
        {/* Section CTA - COMPLÈTEMENT REDESSINÉE */}
        <div className="mt-24" data-aos="fade-up" data-aos-delay="500">
