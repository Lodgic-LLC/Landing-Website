      ...
      <section className="bg-[#FFFFFF] relative">
        ...
        <div className="relative z-[1] container mx-auto px-4 max-w-7xl py-16 md:py-20 ">
          ...
          <div className="text-center max-w-3xl mx-auto mb-14">
            ...
            <div className="w-24 h-1.5 bg-[#F8F6F2]/70 mx-auto mb-6 rounded-full"></div>
              ...
              <div className="flex flex-col md:flex-row justify-center items-center gap-4 md:gap-6">
                ...
                <div className="relative w-full md:w-auto md:flex-1 max-w-md">
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 rounded-md border border-[#D1D5DB] focus:outline-none focus:ring-2 focus:ring-[#C2542D] focus:border-[#C2542D]/70 transition-colors duration-200 shadow-sm placeholder:text-[#6B7280] text-[#111827] bg-white"
                ...
                <div className="flex flex-wrap justify-center gap-3 items-center">
                  <div className="flex items-center gap-2">
                    ...
                    <select
                      ...
                      className="px-3 py-2.5 rounded-md border border-[#D1D5DB] bg-white focus:outline-none focus:ring-2 focus:ring-[#C2542D] focus:border-[#C2542D]/70 transition-colors duration-200 shadow-sm text-[#111827]"
          ...
          {filteredPosts.length === 0 ? (
            ...
            <div className="grid gap-8 md:gap-10 lg:gap-12 md:grid-cols-2 lg:grid-cols-3">
              {filteredPosts.map((post, index) => (
                <article
                  key={post.slug}
                  className="group flex flex-col overflow-hidden rounded-xl border border-[#E0E0E0] bg-[#FAF3E0]/40 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1.5 hover:border-[#C2542D]/60"
                >
                  <Link
                    href={`/blog/${post.slug}`}
                  ...
                  >
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-[#23211F]/70 via-[#23211F]/30 to-transparent opacity-80 group-hover:opacity-90 transition-opacity duration-300"></div>

                    <div className="absolute bottom-0 left-0 right-0 p-4 md:p-5">
                      <span className="inline-block px-3 py-1 text-xs font-semibold text-[#C2542D] bg-[#C2542D]/10 rounded-full mb-2 group-hover:bg-[#C2542D]/20 transition-colors">
                        {post.category}
                      </span>
                    ...
                    <div className="flex items-center justify-between mt-auto pt-3 border-t border-[#EEEEEE]">
                      <div className="flex flex-col sm:flex-row sm:items-center gap-x-3 gap-y-1.5 text-xs md:text-sm text-[#6B7280]">
                        <span className="flex items-center">
                          <FaUserCircle className="w-3.5 h-3.5 mr-1.5 text-[#C2542D]" />
                          {post.author}
                        </span>
                        <span className="flex items-center">
                          <FaCalendarAlt className="w-3.5 h-3.5 mr-1.5 text-[#C2542D]" />
                      ...
                      <Link
                        href={`/blog/${post.slug}`}
                        className="text-[#C2542D] hover:text-[#C2542D]/80 font-semibold text-sm inline-flex items-center group/link"
