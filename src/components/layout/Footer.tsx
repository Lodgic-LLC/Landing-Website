        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 mb-16">
          ...
          <div className="space-y-7">
            ...
            <p className="text-gray-400 text-sm leading-relaxed tracking-wide">
              Solutions digitales sur mesure pour transformer vos idées en expériences numériques exceptionnelles. Nous
              créons des applications web et mobiles innovantes qui répondent à vos besoins spécifiques.
            </p>
