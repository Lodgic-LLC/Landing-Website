...
export default function Navbar() {
  ...
  return (
    <nav className={`fixed top-0 inset-x-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-white border-b border-gray-100' : 'bg-[#f6f7fc] border-b border-transparent'}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-[80px]">
          {/* Logo */}
          <div className="flex-shrink-0">
            <Link href="/" className="flex items-center" aria-label="Accueil Lodgic">
              <span className="font-bricolage-grotesque-bold text-blue-600 text-3xl">Lodgic</span>
            </Link>
          </div>
          ...
          <div className="hidden md:flex md:items-center md:space-x-2 lg:space-x-4">
            ...
            <Link href="/rendez-vous">
              <span className="px-3 py-3 rounded-md text-sm font-bricolage-grotesque-regular leading-6 [30px] text-[16px] transition-all duration-200 text-blue-600 border border-blue-600 hover:bg-blue-600 hover:text-white">Nous Contacter</span>
            </Link>
          </div>
      ...
      >
        <div className="px-4 pt-2 pb-4 space-y-1 bg-white shadow-md">
          ...
          <div className="pt-2">
            <Link
              href="/rendez-vous"
              className="flex items-center justify-center w-full px-4 py-3 rounded-full text-base font-semibold transition-colors bg-blue-600 text-white hover:bg-blue-700 shadow-sm"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
