      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-20" data-aos="fade-up">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Nous allions expertise technique, accompagnement sur mesure et
            vision long terme pour transformer vos idées en solutions digitales.
          </p>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-white border border-gray-200 rounded-lg px-8 py-6 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8">
              <div className="flex items-center">
                ...
                <div>
                  <h4 className="text-lg font-inter-bold text-gray-900">
