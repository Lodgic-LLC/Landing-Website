        ...
        <>
            ...
            <section className="w-full bg-gradient-to-br from-blue-600 to-blue-800 pt-24 md:pt-32 overflow-hidden relative">
                ...
                <div className="max-w-7xl mx-auto px-6 relative z-10">
                    <div className="flex flex-col text-center pb-20 md:pb-24">
                        <h1 className="font-bold text-4xl md:text-5xl lg:text-6xl text-white leading-tight mb-6">
                            Nos <span className="bg-gradient-to-r from-blue-200 to-white text-transparent bg-clip-text">Réalisations</span>
                        </h1>

                        <p className="text-white/90 text-lg md:text-xl mb-8 max-w-3xl mx-auto leading-relaxed">
                            Découvrez nos projets récents et apprenez comment nous aidons nos clients à développer des applications performantes et innovantes.
                        </p>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="space-y-24">
                        {projects.map((project, index) => (
                            <div key={project.id} className="flex flex-col lg:flex-row gap-12 items-center">
                                {/* Image du projet */}
                                <div className={`w-full lg:w-1/2 order-2 ${index % 2 !== 0 ? 'lg:order-1' : 'lg:order-2'}`}>
                                ...
                                <div className={`lg:w-1/2 order-1 ${index % 2 !== 0 ? 'lg:order-2' : 'lg:order-1'}`}>
                                    <div className="space-y-6">
                                        <div className="space-y-2">
                                            ...
                                            <p className="text-xl font-semibold text-blue-600">{project.subtitle}</p>
                                        </div>
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {project.tech.map((tech, i) => (
                                                <span key={i} className="bg-blue-100 text-blue-800 text-xs font-medium px-2.5 py-1 rounded-md">
                                                    {tech}
                                                </span>
                                            ))}
                                        </div>
                                        ...
                                        <div className="space-y-3">
                                            <h3 className="font-semibold text-gray-900">Fonctionnalités clés :</h3>
