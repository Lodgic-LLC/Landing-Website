        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-xl text-blue-100 max-w-2xl mb-10">
              Une plateforme innovante combinant l'IA générative et la technologie blockchain pour créer et échanger des
              NFT uniques
            </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto -mt-32 relative z-20 rounded-2xl overflow-hidden shadow-2xl">
            <img src="/images/forge-main.png" alt="Interface principale de Forge AI" className="w-full h-auto" />
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg text-gray-700 mb-6">
              Forge AI est une plateforme révolutionnaire qui permet aux utilisateurs de créer des NFT uniques à partir
