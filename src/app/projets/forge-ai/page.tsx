        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg text-gray-700 mb-6">
              Forge AI est une plateforme qui permet aux utilisateurs de créer des NFT uniques à partir de simples
              descriptions textuelles, puis de les vendre sur une marketplace intégrée. Notre mission était de
              développer une solution qui démocratise la création artistique numérique en combinant l'IA générative et
