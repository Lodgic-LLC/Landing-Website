  ...
  return (
    <html lang="fr" className="overflow-x-hidden overscroll-none">
      <head>
        ...
        <Script
          src="https://cs.iubenda.com/autoblocking/3950256.js"
        ...
        {/* Google Ads */}
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=AW-16908078298"
          strategy="afterInteractive"
        />
      </head>
      <body
        className={`${inter.variable} bg-white min-h-screen overflow-x-hidden overscroll-none antialiased`}
      >
