  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5" noValidate>
      <div className="grid gap-5 md:grid-cols-2">
        <div>
          <label htmlFor="contact-name" className="block text-sm font-medium text-[#2E2B28] mb-1.5">
        ...
        <div>
          <label htmlFor="contact-email" className="block text-sm font-medium text-[#2E2B28] mb-1.5">
      ...
      <div className="grid gap-5 md:grid-cols-2">
        <div>
          <label htmlFor="contact-phone" className="block text-sm font-medium text-[#2E2B28] mb-1.5">
            Téléphone
          </label>
          <input
            id="contact-phone"
        ...
        <div>
          <label htmlFor="contact-subject" className="block text-sm font-medium text-[#2E2B28] mb-1.5">
            Sujet
          </label>
          <select
            id="contact-subject"
      ...
      <div>
        <label htmlFor="contact-message" className="block text-sm font-medium text-[#2E2B28] mb-1.5">
      ...
      <button
        ...
        className="w-full bg-[#C2542D] hover:bg-[#caeb00] text-black font-semibold py-4 px-6 rounded-md transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-[#9ACD32] focus:ring-offset-2 text-lg cursor-pointer disabled:opacity-70 disabled:cursor-not-allowed"
      >
