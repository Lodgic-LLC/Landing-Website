...
export default function MentionsLegalesPage() {
  return (
    <section className="w-full bg-gradient-to-br from-[#F5F8FC] via-[#f0f4ff] to-[#e8f0ff] pt-24 md:pt-36 pb-16 md:pb-24">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="bg-white/90 backdrop-blur-sm p-8 sm:p-10 md:p-12 rounded-xl shadow-xl border border-[#0F2647]/10 space-y-8">
          <section className="space-y-2">
            <h2 className="font-bricolage-grotesque-bold text-[#0F2647] text-2xl">
              Éditeur du site
            </h2>
