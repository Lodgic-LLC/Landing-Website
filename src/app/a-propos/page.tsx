          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="lg:w-1/2">
              ...
              <p className="text-gray-700 text-lg mb-6 leading-relaxed">
                Notre priorité est la réelle collaboration avec vous, pour que
                votre application soit parfaitement adaptée à vos besoins.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="bg-blue-50 p-5 rounded-lg shadow-sm">
                  ...
                  <p className="text-gray-600">
                    On prend vraiment le temps de comprendre ce qui est
                    important pour vous.
                  </p>
                </div>
                ...
                <div className="bg-blue-50 p-5 rounded-lg shadow-sm">
                  ...
                  <p className="text-gray-600">
                    Pas de jargon technique ! On vous explique tout simplement.
                  </p>
                </div>
                ...
                <div className="bg-blue-50 p-5 rounded-lg shadow-sm">
                  ...
                  <p className="text-gray-600">
                    Besoin de nous ? On répond présent rapidement.
                  </p>
                </div>
              </div>
            </div>
