            ...
            <div className="flex flex-col lg:flex-row items-center gap-12">
              ...
              <div className="lg:w-1/2" data-aos="fade-right">
                ...
                <p className="text-gray-700 text-lg mb-6 leading-relaxed">
                  Chez Lodgic, nous abordons chaque projet avec une méthodologie
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-600">
                        Nous prenons le temps de comprendre vos objectifs, votre
                        marché et vos défis spécifiques pour créer une solution
                        adaptée a vos besoins.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-600">
                        Nous ne nous contentons pas de livrer un produit final.
                        Nous vous accompagnons dans l'amélioration continue de
                        votre produit.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center p-4 bg-gray-50 rounded-lg">
                      ...
                      <div>
                        <h4 className="font-inter-bold text-gray-900">
                          Conseils et analyse des besoins
                        </h4>
                        <p className="text-gray-600 text-sm">
                          Compréhension de vos idées, besoins et objectifs.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center p-4 bg-gray-50 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">
                          Suivi aprés réalisation du projet et amélioration
                          continue de votre application.
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            >
              ...
              <div className="space-y-2 text-gray-600 text-sm">
                <p className="leading-relaxed">
                  ...
                  projet. Il analyse vos besoins et objectifs pour créer un
                  cahier des charges précis qui servira de base à la
                  réalisation.
                </p>
