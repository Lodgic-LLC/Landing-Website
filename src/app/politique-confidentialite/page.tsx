    ...
    <div className="bg-white pt-20">
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p>Lodgic peut collecter les données personnelles suivantes :</p>
          <ul>
            <li>Nom et prénom</li>
            <li>Adresse email</li>
          ...
          <p>
            Vos données personnelles sont destinées à notre équipe interne. Elles peuvent également être partagées avec
            des sous-traitants (hébergement, CRM, outils marketing) qui agissent selon nos instructions et pour notre
            compte.
          </p>
          ...
          <p>Pour exercer ces droits, vous pouvez nous contacter à l'adresse email : contact.lodgic@gmail.com</p>
