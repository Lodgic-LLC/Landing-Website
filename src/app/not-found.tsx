  ...
  return (
    <section className="w-full bg-[#F8F6F2] pt-24 md:pt-36 overflow-hidden relative min-h-screen flex items-center">
      <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
        ...
        <div className="mb-8">
          <h1 className="font-bricolage-grotesque-bold text-[#2E2B28] text-8xl sm:text-9xl md:text-[10rem] leading-none mb-4 opacity-90">
            404
          </h1>
        ...
        <h2 className="font-bricolage-grotesque-bold text-[#2E2B28] text-2xl sm:text-3xl md:text-4xl mb-6">
          Page non trouvée
        </h2>
