      ...
      <main className="bg-[#F8F6F2] min-h-screen pt-32 pb-24">
        <div className="max-w-4xl mx-auto px-6">
          <div className="bg-white border border-gray-200 rounded-2xl p-8 md:p-12 shadow-sm">
            <p className="text-sm font-inter font-semibold uppercase tracking-[0.2em] text-[#2E2B28]/60 mb-4">
              Auteur
            </p>
            <h1 className="text-3xl md:text-4xl font-sofia-bold text-[#2E2B28] mb-2">
              {author.name}
            </h1>
            <p className="text-base text-[#6B655D]/80 font-inter mb-6">{author.jobTitle}</p>
            <p className="text-[#2E2B28]/80 font-inter leading-relaxed">{author.bio}</p>
                ...
                {author.sameAs.map((url) => {
                  ...
                  return (
                    <a
                      ...
                      rel="me noopener"
                      target="_blank"
                      className="inline-flex items-center rounded-full border border-[#2E2B28]/15 bg-white px-4 py-1.5 text-xs font-inter font-medium text-[#2E2B28] hover:border-[#2E2B28]/40 transition-colors"
                    >
                      {host}
                    </a>
                  )
          ...
          {posts.length > 0 && (
            <section className="mt-12">
              <h2 className="text-2xl font-sofia-bold text-[#2E2B28] mb-6">
              ...
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {posts.map((post) => (
                  ...
                  >
                    ...
                    <p className="text-sm text-[#6B655D]/75 font-inter">{post.summary}</p>
                  </li>
                ))}
              </ul>
            </section>
