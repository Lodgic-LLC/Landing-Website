...
export const PAGES_SERVICE: PageService[] = [
  {
    ...
    expertise: {
      ...
      closing: [
        ...
        'Le site d’**Alliance-TRAVAUX**, un collectif d’artisans toulousains, est un exemple de ce que je livre : 23 pages, formulaire de devis, référencement local sur 22 communes.',
      ],
      crossLinks: [
        {
