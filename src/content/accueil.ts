...
export const etapes = [
  ...
  { n: '03', title: 'Développement', text: 'Je vous présente les écrans prévus au cadrage, puis vous testez une version de travail au fil du développement.', livrable: 'Des écrans validés et une version à tester.' },
